...
import { Box, Card, CardContent, Divider, Typography, Chip, Button, Stack, Paper, CircularProgress } from '@mui/material';
  ...
  if (loading) {
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', py: 8 }}>
        ...
        <Typography sx={{ mt: 2, color: '#aaa' }}>Connecting to LangChain4j & Gemini RAG AI Engine...</Typography>
      </Box>
    );
  }
      ...
      <Card sx={{ mb: 3, background: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)', color: '#fff', borderRadius: 3, boxShadow: 4 }}>
        <CardContent sx={{ p: 3 }}>
          <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
            <Box direction="row" spacing={1} sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Chip 
              ...
              label="LangChain4j + Gemini RAG Powered" 
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} sx={{ mt: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Typography variant="body1">
                <strong>Duration:</strong> {recommendation?.duration || 30} mins
              </Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <LocalFireDepartmentIcon sx={{ color: '#f87171' }} />
              <Typography variant="body1">
                <strong>Calories:</strong> {recommendation?.caloriesBurned || 250} kcal
              </Typography>
            </Box>
        ...
        <Card sx={{ background: '#1e293b', color: '#f8fafc', borderRadius: 3, boxShadow: 4 }}>
          <CardContent sx={{ p: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
              <PsychologyIcon sx={{ color: '#a855f7', fontSize: 36 }} />
              <Typography variant="h5" sx={{ fontWeight: 700 }}>
                AI Fitness Coach Breakdown
              </Typography>
            </Box>

            <Paper sx={{ p: 2.5, mb: 3, background: 'rgba(15, 23, 42, 0.6)', color: '#e2e8f0', borderRadius: 2, borderLeft: '4px solid #a855f7' }}>
              <Typography variant="subtitle1" sx={{ fontWeight: 600, color: '#c084fc', mb: 1 }}>
                Exercise Science & Performance Analysis
              </Typography>
              <Typography paragraph sx={{ whitespace: 'pre-line', mb: 0 }}>
